add wave -noupdate -divider {jtag_uart_sys_cpu: top-level ports}
...
add wave -noupdate -divider {jtag_uart_sys_cpu: common}
...
add wave -noupdate -divider {jtag_uart_sys_cpu: breaks}
